    ...
    <footer className="bg-white border-t border-gray-100 pt-16 pb-12 font-sans relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8 pt-2">
            {/* Column 2: Product */}
            <div>
              ...
              <ul className="space-y-3.5 text-sm text-gray-500">
                ...
                <FooterLink href="#">ATS Optimization</FooterLink>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-xs">
            © {currentYear} Amanox AI. All rights reserved.
          </p>
